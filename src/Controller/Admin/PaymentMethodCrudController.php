    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ImageField::new('imageUrl', "Logo")
                ->setUploadDir('public/assets/images/payment_methods_logos') // Chemin relatif au projet - NB: dans le cours Udemy, il rajoute /categories sur les 2 chemin, mais ça ne fonctionne pas chez moi
                ->setBasePath('assets/images/payment_methods_logos') // Chemin pour afficher l'image dans l'admin
